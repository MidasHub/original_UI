...
export const environment = {
  ...
  baseApiUrl: JSON.parse(localStorage.getItem('mifosXServerURL')) || 'https://dev-partner.kiotthe.com',  // For connecting to server running elsewhere update the base API URL
